...
class DiceMetric:
    def __init__(self, num_classes=CFG.n_classes):
        ...
        # Store raw pixel counts instead of pre-calculated scores
    ...
    def accumulate(self, outputs: np.ndarray, targets: np.ndarray) -> None:
        """
        Only accumulates pixel counts for later Dice calculation.
        """
        ...
        for i in range(batch_size):
            for c in range(self.num_classes):
                ...
                # Just accumulate raw counts, no score calculation
    ...
    def calculate_score(self):
        """
        Calculates pixel-level Dice scores using accumulated counts.
        """
        ...
        for c in range(self.num_classes):
            ...
            # Skip empty classes in both prediction and target
            if denominator > 0:
        ...
        # Calculate overall Dice across all classes
